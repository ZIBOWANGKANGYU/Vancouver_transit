...
###Distribution of stops by business
...
with open(os.path.join(os.getcwd(), "Data_Tables", data_version,'stop_times.json'), "w+") as stop_times_outfile:
    json.dump(stop_times.to_json(), stop_times_outfile)
